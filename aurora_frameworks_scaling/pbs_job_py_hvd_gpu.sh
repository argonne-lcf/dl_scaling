...
do
    ...
    echo ${BUF_SIZE}
        ...
        python3 ./profiling_app_py_hvd_gpu.py  ${BUF_SIZE} > ./out$PBS_JOBID/profiling_app_py_hvd_gpu/${PBS_JOBID}_${NNODES}_${NRANKS}_${RANKS_PER_NODE}_${BUF_SIZE}_py_hvd_profiling_out.txt
    date
    echo ${BUF_SIZE}
done
