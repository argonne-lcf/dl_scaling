...
do
    date
        ...
        python3 ./profiling_app_py_torch_ccl_gpu.py ${BUF_SIZE} \
        > ./out$PBS_JOBID/profiling_app_py_torch_ccl_gpu/${PBS_JOBID}_${NNODES}_${NRANKS}_${RANKS_PER_NODE}_${BUF_SIZE}_py_ccl_profiling_out.txt
    date 
done
