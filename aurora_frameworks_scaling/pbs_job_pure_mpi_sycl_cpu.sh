...
which python
mkdir -p ./out$PBS_JOBID/profiling_app_pure_mpi_sycl_cpu 
...
do
    ...
    echo ${BUF_SIZE}
        ...
        ./profiling_app_pure_mpi_sycl_cpu ${BUF_SIZE} > ./out$PBS_JOBID/profiling_app_pure_mpi_sycl_cpu/${PBS_JOBID}_${NNODES}_${NRANKS}_${RANKS_PER_NODE}_${BUF_SIZE}_c_mpi.txt
    date
    echo ${BUF_SIZE}
