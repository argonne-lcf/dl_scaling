...
do
    ...
    mpiexec ${EXT_ENV}  --env CCL_LOG_LEVEL=info  --env CCL_PROCESS_LAUNCHER=pmix  --env CCL_ATL_TRANSPORT=mpi \
                        ...
                        --coll allreduce -j off -i 1 -w 0  --backend sycl  --sycl_dev_type gpu >  ./out/c_oneccl/${PBS_JOBID}_${NNODES}_${NRANKS}_${RANKS_PER_NODE}_${BUF_SIZE}_sycl_ccl_gpu_out_w1.txt
    date
done
