...
def train(train_loader, model, criterion, optimizer, epoch, device, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if i >= args.steps and args.steps > 0:
            print('Throughput: {:.3f} images/s'.format(args.steps * args.batch_size / batch_time.sum), args.batch_size, batch_time.sum)
            print('Throughput: {:.3f} images/s'.format(args.steps * args.batch_size / (time.time() - start)), args.batch_size, (time.time() - start))
            exit()
